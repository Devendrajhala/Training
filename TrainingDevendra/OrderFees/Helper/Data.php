...
namespace TrainingDevendra\OrderFees\Helper;
...
class Data extends AbstractHelper
{
     ...
     */
    const CONFIG_CUSTOM_IS_ENABLED = 'orderfee/orderfee/status';
    const CONFIG_CUSTOM_FEE = 'orderfee/orderfee/orderfee_amount';
    const CONFIG_FEE_LABEL = 'orderfee/orderfee/name';
    const CONFIG_MINIMUM_ORDER_AMOUNT = 'orderfee/orderfee/minimum_order_amount';
